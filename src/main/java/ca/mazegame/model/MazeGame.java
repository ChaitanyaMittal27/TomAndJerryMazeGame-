...
public class MazeGame {
	...
	public boolean isValidPlayerMove(MoveDirection move) {
		...
		//DEBUG
		//System.out.println("Validating move to " + targetLocation + ": " + maze.isCellOpen(targetLocation));
	...
	public void recordPlayerMove(MoveDirection move) {
		...
		// Trigger cat movements: handled in controller.
		//doCatMoves();

		// Check if the player lost (collided with a cat)
		if (hasUserLost()) {
			System.out.println("Game Over: Player collided with a cat!");
		}
	}
	...
	public void doCatMoves() {
		// DEBUG
		//System.out.println("Starting cat movements...");
		for (Cat cat : cats) {
			cat.doMove();
			//System.out.println("Cat moved to: " + cat.getLocation());
		}

		// Check if the player collided with a cat
		if (hasUserLost()) {
			System.out.println("Player collided with a cat. Game over.");
		}
	}
	...
	// getters for location of player and cheese
